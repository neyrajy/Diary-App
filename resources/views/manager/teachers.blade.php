        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-warning btn-sm" href="{{ route('manager.register-teacher') }}">Add Teacher</a> </span></h5>
                    <table class="table table-responsive table-striped">
                        ...
                        @foreach($teachers as $teacher)
                            ...
                            <td>
                                <a href="/manager/teachers-edit/{{$teacher->id}}" class="btn btn-primary btn-sm">Edit</a>
                            </td>
                            <td>
                                <form action="/manager/teachers/destroy/{{$teacher->id}}" method="POST">
                                    @csrf
                                    @method('DELETE')
