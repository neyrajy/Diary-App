            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/notifications" method="POST" class="event-callendar-col mt-2">
                        ...
                        <button type="submit" class="submit-event-recorder" style="background-color:#007BFF;">Send</button> <button type="button" class="view-notif" style="color:#FFF; background-color:orange;"><a href="/manager/view-nofication">View Notifications</a></button>
                    </form>
                    </div>
                </div>
            </div>
