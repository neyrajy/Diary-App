...
@section('content')
    ...
    <div class="row mt-0">
                ...
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        <span style="margin-top:-20px" class="d-flex justify-content-end">
                            <a class="btn btn-warning btn-sm" href="#" onclick="showMyForm(event)">Add New Car</a>
                        </span>
                    </h5>
        ...
        <form action="/storecars" method="POST" class="staff-reg-ed hidden" enctype="multipart/form-data">
            ...
            <button type="submit" class="add-staff-btn" style="background-color: #007BFF;">Add A Car</button>
