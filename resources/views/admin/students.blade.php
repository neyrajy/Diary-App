...
<div class="tab-content" id="adminTabContent">
    ...
    <div class="tab-pane fade" id="sections" role="tabpanel" aria-labelledby="sections-tab">
        <br><button class="btn btn-kprimary " style="background-color:#f1d016;" data-toggle="modal" data-target="#addSectionModal">Add Section</button>
                            ...
                            <form action="{{ route('classes.store') }}" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" style="background-color:#f1d016;" class="btn btn-kprimary">Add Class</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ route('sections.store') }}" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="submit" style="background-color:#f1d016;"  class="btn btn-kprimary">Add Section</button>
                                     </div>
                                </div>
                            </form>
                        </div>
